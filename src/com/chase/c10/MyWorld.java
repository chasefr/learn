...
public class MyWorld {
    public static void main(String[] args) {
        ...
        Vector animals_2 = new Vector();
        animals_2.addElement(new Animal("Bosco1 the dog", house));
        animals_2.addElement(new Animal("Ralph1 the hamster", house));
        animals_2.addElement(new Animal("Fronk1 the cat", house));
